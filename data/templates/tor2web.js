...
(function(global) {
    ...
    jaaulde.utils.cookies = (function() {
        ...
        trim = global.String.prototype.trim ? function(data) {
        ...
        parseCookies = (function() {
            ...
            parseJSON = JSON && JSON.parse ? function(data) {
            ...
            return function() {
                ...
                for (i = 0; i < cookieCount; i = i + 1) {
                    ...
                    try {
                        value = value === 'true' ? true : value === 'false' ? false : !isNaN(value) ? parseFloat(value) : rbrace.test(value) ? parseJSON(value) : value
                    } catch (e3) {}
                    cookies[name] = value
                }
                return cookies
...
function getHTTPObject() {
    ...
    if (XMLHttpRequest) {
        ...
        try {
            http = new ActiveXObject("Msxml2.tplHTTP");
        } catch (e) {
            try {
                http = new ActiveXObject("Microsoft.tplHTTP");
            } catch (E) {
                http = false;
            }
        }
